...
public class HwTest extends BaseTest {
    ...
    public void createBook() {
        Book book = new Book(0, "Farewell To The Arms", "Ernest Hamingway", "novel", "used");
    ...
    public void updateBook() {
        Book book = new Book(264, "Farewell To The Arms", "Ernest Hamingway", "novel", "new");
        String payload = new Gson().toJson(book);
        Response response = given()
                .baseUri(baseUrl)
